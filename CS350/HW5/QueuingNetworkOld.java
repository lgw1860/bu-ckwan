public class QueuingNetworkOld {
	...
	public QueuingNetworkOld(double SimTime)
	{
	...
	public void simulate()
	{
		...
		double aveLamb = 1/(sumArr/numDepart);
		System.out.println("ave Lambda: " + aveLamb);
		double calcLamb = ((double)sumQ/(double)numDepart) / (sumTq/numDepart);
		System.out.println("calc Lambda: " + calcLamb);
		System.out.println("diff: " + Math.abs(calcLamb - aveLamb));
	}
