 ...
 */
import java.util.*;
public class DiskRequestsRandom {
	...
	public DiskRequestsRandom(double Lambda, double Ts, double maxTime)
	{
		this.lambda = Lambda;
		this.Ts = Ts;
	...
	public static void main(String[] args)
	{
		...
		//qu.run();
		DiskRequestsRandom dr = new DiskRequestsRandom(0.05, 500, 2, 0.1);
		dr.run();
		
	}


    public DiskRequestsRandom(double lambda, double n, double u, double v)
    {
            this.lambda = lambda;
            this.n = n;
            this.u = u;
