...
public class DiskRequestsSCAN {
	...
	public DiskRequestsSCAN(double Lambda, double Ts, double maxTime)
	{
		this.lambda = Lambda;
		this.Ts = Ts;
	...
	public static void main(String[] args)
	{
		...
		//qu.run();
		DiskRequestsSCAN dr = new DiskRequestsSCAN(0.05, 500, 2, 0.1);
		dr.run();
		
	}


    public DiskRequestsSCAN(double lambda, double n, double u, double v)
    {
            this.lambda = lambda;
            this.n = n;
            this.u = u;
